...
def reorder_molecule_by_smiles(mol: Chem.Mol) -> Optional[Chem.Mol]:
    ...
    print(Chem.MolToSmiles(canonical_mol))
    print(mol_copy.GetConformer().GetPositions().shape)
    print(canonical_mol.GetConformer().GetPositions().shape)
